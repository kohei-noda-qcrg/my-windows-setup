...
$data = @('copy.ps1', 'copyfile.bat', 'do_not_turn_off.pow', 'imsautomount.sh', 'restore_power_settings.ps1', 'ubuntusoftwareinstall.sh', 'Update Anyconnect Adapter Interface Metric for WSL2.xml', 'UpdateAnyConnectInterfaceMetric.ps1', 'vscodeubuntusetup.sh', 'windowssetup.ps1', "writeubuntusettings.sh")
$data | ForEach-Object {
