...
$files = @('copy.ps1', 'do_not_turn_off.pow', 'install-winget.ps1', 'Microsoft.Powershell_profile.ps1', 'restore_power_settings.ps1', 'setup-wsl.ps1', 'windowssetup.ps1', 'winget.ps1')
